from my_project.auth.service import client_location_service
from my_project.auth.controller.general_controller import GeneralController

class ClientLocationController(GeneralController):
    """
    Realisation of ClientLocation controller.
    """
    _service = client_location_service
