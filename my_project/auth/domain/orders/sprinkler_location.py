...
class SprinklerLocation(db.Model, IDto):
    """
    Model declaration for SprinklerLocation.
    """
    __tablename__ = "sprinkler_location"
    ...
    def __repr__(self) -> str:
        return f"SprinklerLocation({self.ID}, {self.client_ID}, '{self.location_name}', '{self.gps_latitude}', '{self.gps_longitude}')"
    ...
    @staticmethod
    def create_from_dto(dto_dict: Dict[str, Any]) -> SprinklerLocation:
        """
        Creates domain object from DTO
        :param dto_dict: DTO object
        :return: Domain object
        """
        obj = SprinklerLocation(
            ID=dto_dict.get("ID"),
